...
if [ ! -f check-mk-cloud-${VERSION}_0.kinetic_amd64.deb ]; then
    wget https://download.checkmk.com/checkmk/${VERSION}/check-mk-cloud-${VERSION}_0.lunar_amd64.deb
fi
...
patch -p0 < ../patches/python-make-set-arm-architecture.patch
...
patch -p0 < ../patches/bazel-set-aarch32-architecture.patch
...
ar x ../check-mk-cloud-${VERSION}_0.lunar_amd64.deb
...
cp /tmp/snap7-1.4.2/build/unix/arm_v6_linux.mk /tmp/snap7-1.4.2/build/unix/armv6l_linux.mk
#ln -s arm_v6-linux omd/packages/snap7/snap7-1.4.2/build/bin/armv6l-linux
cp /tmp/snap7-1.4.2/build/unix/arm_v7_linux.mk /tmp/snap7-1.4.2/build/unix/armv7l_linux.mk
#ln -s arm_v7-linux omd/packages/snap7/snap7-1.4.2/build/bin/armv7l-linux
